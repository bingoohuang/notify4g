...
# Default-Stop:      0 1 6
# Short-Description: Start rigaga at boot time
### END INIT INFO
...
# Command-line options that can be set in /etc/default/notify4g.  These will override
...
if [ -z "$STDERR" ]; then
    STDERR=/var/log/notify4g/notify4g.log
fi
if [ ! -f "$STDERR" ]; then
...
daemon=/usr/bin/notify4g

# pid file for the daemon
pidfile=/var/run/notify4g/notify4g.pid
